...
class CustomerService:
    ...
    def load_persisted(self, path: str = "./app/data/customers.jsonl"):
        logging.log(logging.INFO, "Customer Service - Carregar dados armazenados de clientes")
    ...
    def persist(self, path: str = "./app/data/customers.jsonl"):
        ...
        with open(path, "w") as file:
            for customer in self.__customers:
                file.write(json.dumps(customer, default=lambda o: o.__dict__, skipkeys=True) + "\n")
    ...
    def find_customer_by_id(self, customer_id: int):
        ...
        if customer_id is None:
            logging.log(logging.INFO, "Customer Service - O ID do cliente não pode ser nulo.")
    ...
    def find_customer_by_name(self, search_string: str):
        ...
        return [customer for customer in self.__customers if search_string.lower() in customer.name.lower()]

    def find_customer_by_email(self, search_string: str):
        logging.log(logging.INFO, "Customer Service - Encontrar Cliente pelo email")
        return [customer for customer in self.__customers if search_string.lower() in customer.email.lower()]
